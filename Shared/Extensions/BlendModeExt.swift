...
enum BlendModeFamily: String, CaseIterable, Hashable {
    case normal     = "Normal"
    case darken     = "Darken"
...
extension BlendMode: @retroactive CaseIterable {
    ...
    var anchor: Int {
        switch self {
        case .color:          return 1
        case .colorBurn:      return 2
        case .colorDodge:     return 3
        case .darken:         return 4
        case .destinationOut: return 5
        case .destinationOver: return 6
        case .difference:     return 7
        case .exclusion:      return 8
        case .hardLight:      return 9
        case .hue:            return 10
        case .lighten:        return 11
        case .luminosity:     return 12
        case .multiply:       return 13
        case .normal:         return 14
        case .overlay:        return 15
        case .plusDarker:     return 16
        case .plusLighter:    return 17
        case .saturation:     return 18
        case .screen:         return 19
        case .softLight:      return 20
        case .sourceAtop:     return 21
        default:              return 1
        }
    }

    var family: BlendModeFamily {
        switch self {
        case .normal:                              return .normal
        case .multiply, .darken, .colorBurn, .plusDarker: return .darken
        case .screen, .lighten, .colorDodge, .plusLighter: return .lighten
        case .overlay, .softLight, .hardLight:     return .contrast
        case .difference, .exclusion:              return .inversion
        case .hue, .saturation, .color, .luminosity: return .component
        case .destinationOut, .destinationOver, .sourceAtop: return .compositing
