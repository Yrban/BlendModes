...
struct HelpView: View {
    ...
    • Opacity — adjusts the overall transparency of the circle group.
    • Blur — applies a Gaussian blur to the circle group.
    • Colors — add up to 5 colored circles. Swipe a row left to delete it.
    • Background — choose the background color shown behind the circles.
    """
}
